...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        prob_have_the_number_of_genes = 1
        ...
        # unconditional probability: the person doesn't have parents
        if not father and not mother:
            prob_have_the_number_of_genes *= PROBS["gene"][genes] 

        else:
            prob_gene_from_parents = {"mother": 0, "father": 0}
            ...
            # probability that the person got the gene from both parents 
            else:
                prob_have_the_number_of_genes *= prob_gene_from_parents["mother"] * prob_gene_from_parents["father"]  

        if person in have_trait:
            result_prob *= prob_have_the_number_of_genes * PROBS["trait"][genes][True]
        else:      
            result_prob *= prob_have_the_number_of_genes * PROBS["trait"][genes][False]
